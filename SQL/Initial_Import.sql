...
CREATE TABLE IF NOT EXISTS `professors` (
  ...
  `p_salary`  INT UNSIGNED                                                                     NOT NULL DEFAULT 0,
  PRIMARY KEY (`p_ssn`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `course` (
  `c_id`       INT          NOT NULL,
  `c_title`    VARCHAR(80)  NULL,
  `c_textbook` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `course_sections` (
  ...
  PRIMARY KEY (`section_num`, `course_fkey`),
...
CREATE TABLE IF NOT EXISTS `class_meetings` (
  `meeting_course`  INT                                                                                 NOT NULL,
  `meeting_section` INT                                                                                 NOT NULL,
  `day`             ENUM ('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday') NOT NULL,
  `start_time`      TIME                                                                                NOT NULL,
  `end_time`        TIME                                                                                NOT NULL,
  PRIMARY KEY (`meeting_course`, `meeting_section`, `day`),
  INDEX `fkey_section_idx` (`meeting_section` ASC, `meeting_course` ASC),
  CONSTRAINT `fkey_meeting_section`
  FOREIGN KEY (`meeting_course`, `meeting_section`)
  REFERENCES `course_sections` (`course_fkey`, `section_num`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `enrollment` (
  ...
  PRIMARY KEY (`enrolled_course`, `enrolled_section`, `enrolled_student`),
  INDEX `fkey_enrolled_student_idx` (`enrolled_student` ASC),
  INDEX `fkey_enrolled_section_idx` (`enrolled_section` ASC, `enrolled_course` ASC),
  CONSTRAINT `fkey_enrolled_section`
  FOREIGN KEY (`enrolled_course`, `enrolled_section`)
  REFERENCES `course_sections` (`course_fkey`, `section_num`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
